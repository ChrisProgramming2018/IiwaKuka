...
class ReplayBufferDepth(object):
    ...
    def test_surface_normals(self, index):
        ...
        cv2.waitKey(0)
        cv2.imshow("surface_image", array_surface_normals * 255)
        cv2.waitKey(0)
