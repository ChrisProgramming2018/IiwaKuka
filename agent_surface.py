...
class TQC(object):
    def __init__(self, state_dim, action_dim, config):
        ...
        #self.model.load_model("trained_model_only_sim/model-21170.39453125")   # for simulation
        #self.model.load_model("simreal_normal_model/model_step_1650_eval_loss_21170.3222656250")  # for simandreal working
        p = "model_to_test_juli/seed_4/simreal_normal_model_seed_4/model_step_2930_eval_loss_21170.0000000000"
        p = "seed_3/simreal_normal_model_seed_3/model_step_2090_eval_loss_21170.3632812500"
        p = "working_predicter_models/simreal_normal_model/model_step_1650_eval_loss_21170.3222656250"
        p = "experiments_juli/test_real_data_model/only_real_data/model_step_4000_eval_loss_21169.8593750000"
        p = "experiments_juli/test_sim_real_predicter_juli/sim_real_world_juli/model_step_3000_eval_loss_21170.4765625000"

        self.model.load_model(p)  # seed 2
        #self.model.load_model("simreal_normal_model_seed_3/model_step_1650_eval_loss_21170.7539062500") # seed 3
        #self.model.load_model("simreal_normal_model_seed_4/model_step_1650_eval_loss_21170.4746093750") # seed 4
        #self.model.load_model("simreal_normal_model_seed_5/model_step_1650_eval_loss_21170.3769531250") # seed 5
        print("loaded surface predicter")
        #self.model.load_model(config["real_world_surface_path"])   # for real world
